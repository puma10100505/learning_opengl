...
int main() {
    ...
    GLModel our_model(solution_base_path + "assets/meshes/nanosuit/nanosuit.obj");
    ...
    gl_window_loop(
        [&]() -> void{
            ...
            glm::mat4 projection = glm::perspective(glm::radians(mainScene.MainCamera->Zoom), mainScene.WindowRatio, .1f, 100.0f);
